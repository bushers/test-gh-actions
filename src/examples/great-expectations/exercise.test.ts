...
import { areFriends, createPerson, Person } from '$lib/person';
...
describe('Kanban Board', () => {
  ...
  it(
    ...
    () => {
      ...
      board.addStatus("New");
      expect(board.statuses).toContain("New");
    },
  );
...
describe('Person', () => {
  ...
  it('will remove a friend', () => {
    ...
    expect(areFriends(john, paul)).toBe(false);
  });
  ...
  it('will mutually remove friends', () => {
    ...
    expect(areFriends(paul, john)).toBe(false);
  });
});
